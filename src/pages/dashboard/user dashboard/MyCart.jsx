      ...
      <div className="overflow-x-auto">
        <section className="bg-white p-12">
          <div className="w-full flex justify-between mb-9">
            ...
            <div className="text-[#151515] text-[32px] font-bold font-['Cinzel']">total price: <strong>${totalPrice.toFixed(2)}</strong></div>
          ...
          <table className="table">
            ...
            <tbody>
              ...
              {
                cart.map((item, index) =>
                  <tr key={index} className={`${index % 2 == 0 ? "bg-yellow-500/15" : "bg-yellow-500/0"} hover:bg-yellow-200 transition-all duration-300 ease-in-out text-center text-lg`}>
                    <th>{index + 1}</th>
