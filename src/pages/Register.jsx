...
const Register = () => {
  ...
  return (
    <div className="bg-[url(/assets/others/authentication.png)] w-full h-auto pt-40 pb-14">
      <div className="flex flex-col md:flex-row-reverse justify-between items-center w-[1200px] h-[700px] mx-auto shadow-[10px_10px_10px_10px_rgba(0,0,0,0.25)] pl-[100px] py-[50px]">
